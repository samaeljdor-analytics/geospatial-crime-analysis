...
- **Source:** [City of Chicago Data Portal — Crimes 2001 to Present](https://data.cityofchicago.org/Public-Safety/Crimes-2001-to-Present/ijzp-q8t2)
...
![Chicago crime density heatmap](heatmap.png)

*Darker areas indicate a higher concentration of reported incidents within the search radius; lighter areas indicate fewer.*

## Findings

- Density is not evenly distributed — it concentrates most heavily along major road corridors and around the central/downtown area, consistent with higher foot and vehicle traffic in those zones
- The single strongest hotspot centers on Chicago's **Loop / River North area**, near the confluence of the Chicago River branches (approx. 41.89°N, -87.63°W) — consistent with the area's high density of foot traffic, retail, and transit
- Density drops off noticeably toward the outer suburbs within this dataset's coverage area
